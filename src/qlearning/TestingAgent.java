...
//		if(verbose) System.out.println("NUM COL = " + numCol);
    ...
    public Types.ACTIONS act(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
    	...
    	//int salidaEstado = StateManager.caminoMayorDesplazamientoDerecha(stateObs);
    	
    	
    	
    	double[] posJugador = StateManager.getPosicionJugador(stateObs); // Indice del mapa
    	...
    	//mapaObstaculos[(int)posJugador[0][(int) (posJugador[1] = 'J'); // Marcamos la posicion del jugador

//    	int xJugador = (int) posJugador[0];
//    	int yJugador = (int) posJugador[1];
//    	mapaObstaculos[xJugador][yJugador] = 'J';
    	
    	//if(verbose) StateManager.showMapa(stateObs);
//    	
//    	// Percibimos el estado actual e incrementamos su contador
    	ESTADOS estadoActual = StateManager.getEstado(stateObs, this.mapaObstaculos,distanciaJP);
